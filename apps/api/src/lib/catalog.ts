import { buildings, equipmentItems, expeditions, gatherings, professionLabels, recipes, resources, zones } from "@obsidian-astral/shared";
...
export const equipmentItemMap = new Map(equipmentItems.map((item) => [item.key, item]));
